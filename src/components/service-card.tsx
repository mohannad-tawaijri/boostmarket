...
export default function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <Link href={`/services/${service.id}`} className="block group">
      <div className="bg-white/[0.09] rounded-xl border border-white/[0.18] overflow-hidden hover:border-violet-500/40 transition-all card-hover cursor-pointer hover:shadow-lg hover:shadow-violet-600/10">
        {/* Header area */}
        ...
        <div className="p-4">
          ...
          {/* Booster */}
          <div className="flex items-center gap-2.5 mb-3 pb-3 border-b border-white/[0.15]">
