  ...
  return (
    <div className="min-h-screen bg-transparent py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Tabs */}
        <div className="flex flex-wrap gap-2 mb-6 border-b border-white/[0.15] pb-4">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              ...
              {recentActivity.length === 0 ? (
                ...
                <div className="space-y-4">
                  {recentActivity.map((activity) => (
                    <div key={activity.id} className="flex items-start gap-3 p-3 bg-white/[0.07] rounded-lg">
            ...
            <div className="bg-white/[0.09] border border-white/[0.15] rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className="p-4 bg-white/[0.07] rounded-lg hover:bg-white/[0.09] transition-all text-left"
                >
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="bg-white/[0.07] border border-white/[0.18] rounded-lg px-4 py-2 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-violet-500"
                />
              </div>
            </div>
        ...
        {activeTab === 'orders' && (
          <div className="bg-white/[0.09] border border-white/[0.15] rounded-xl p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <select className="bg-white/[0.07] border border-white/[0.18] rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-violet-500">
