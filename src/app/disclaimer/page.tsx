      ...
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="space-y-8 text-[15px] leading-relaxed text-zinc-400">
          ...
          <div>
            ...
            <p>
              BoostMarket يربط المشترين ببائعين مستقلين يقدمون خدمات التعزيز. نحن لا نوظف المعززين، ولا نقوم بأي تعزيز بأنفسنا. جودة كل خدمة تعتمد على البائع الفردي — رغم أننا نبذل قصارى جهدنا للتحقق منهم والتعامل مع النزاعات عندما تسوء الأمور.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              بعض الخدمات تتضمن مشاركة بيانات تسجيل دخول حساب لعبتك مع المعزز. نشجع استخدام الخدمات التي لا تتطلب ذلك كلما أمكن. إذا شاركت بياناتك، غيّر كلمة المرور بعدها وفعّل التحقق بخطوتين. لا يمكن تحميلنا المسؤولية عما يحدث للحسابات التي تشارك الوصول إليها طواعية.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              الألعاب تُحدَّث، والميتا يتغير، وخوارزميات التوفيق تتبدل. قد يواجه المعزز صعوبة غير متوقعة أو يستغرق وقتاً أطول من المتوقع. بينما معظم الطلبات تسير بسلاسة، لا يمكننا الوعد بنتائج محددة — فقط أن البائعين مطالبون ببذل جهد حقيقي لتسليم ما أدرجوه.
            </p>
          </div>
