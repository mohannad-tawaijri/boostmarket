  ...
  return (
    <div className="min-h-screen bg-transparent py-16" dir="rtl">
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        {submitted ? (
          <div className="bg-white/[0.09] border border-white/[0.15] rounded-xl p-8 text-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-white/[0.08] border border-white/[0.18] rounded-lg text-white text-sm placeholder:text-zinc-600 focus:outline-none focus:border-violet-600 transition-colors"
                  placeholder="اسمك"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 bg-white/[0.08] border border-white/[0.18] rounded-lg text-white text-sm placeholder:text-zinc-600 focus:outline-none focus:border-violet-600 transition-colors resize-none"
